...
const ThreeDModel = ({ modelPath }) => { // Accept modelPath as a prop
  ...
  useEffect(() => {
    ...
    // **Lighting Setup**
    const ambientLight = new THREE.AmbientLight(0xffffff, 0.5); // Balanced brightness
        ...
        {showPopup && (
          <div className="rightSidePopup">
            <div className="popupContent">
              ...
              />
              <p>
                The underside of a Shellflower leaf (Solanum tuberosum) is covered with fine hairs (bluish) and glandular cells (yellow), in between the stomata are visible.
              </p>
